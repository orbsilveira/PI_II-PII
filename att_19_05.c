...
void infoEstado(int *est, Decodificador *d, ALUout *saida) {
  ...
  case 0:
    ...
    printf(" Acesso a memória para busca de instrução.\n");
  ...
  case 2:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Cálculo do endereço efetivo para LW/SW/ADDI\n");
    printf(" Endereço calculado: %d\n", saida->resultado);
    break;
  case 3:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Acesso à memória para LW (leitura)\n");
    printf(" Endereço acessado: %d\n", saida->resultado);
    printf(" Dado lido: %d\n", d->dado);
    break;
  case 4:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Conclusão da instrução LW\n");
    printf(" Escrita no registrador $%d: %d\n", d->rt, d->dado);
    break;
  case 5:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Acesso à memória para SW (escrita)\n");
    printf(" Endereço acessado: %d\n", saida->resultado);
    printf(" Dado escrito: %d\n", d->rt);
    break;
  case 6:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Conclusão da instrução ADDI\n");
    printf(" Escrita no registrador $%d: %d\n", d->rt, saida->resultado);
    break;
  case 7:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Execução da instrução tipo R\n");
  ...
  case 8:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Conclusão da instrução tipo R\n");
    printf(" Escrita no registrador $%d: %d\n", d->rd, saida->resultado);
    break;
  case 9:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Conclusão do desvio condicional (BEQ)\n");
  ...
  case 10:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Conclusão do desvio incondicional (J)\n");
    printf(" Novo PC: %d\n", d->addr);
    break;
  }
}
