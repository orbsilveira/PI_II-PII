...
void infoEstado(int *est, Decodificador *d, ALUout *saida, Registradores *r) {
  ...
  case 2:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Calculo do endereço efetivo para LW/SW/ADDI\n");
    printf(" Endereco calculado: %d\n", saida->resultado);
    break;
  case 3:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Acesso a memoria para LW (leitura)\n");
  ...
  case 5:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Acesso à memoria para SW (escrita)\n");
    printf(" Endereço acessado: %d\n", saida->resultado);
    printf(" Dado escrito: %d\n", d->rt);
    break;
  case 6:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Conclusao da instrucao ADDI\n");
  ...
  case 9:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Conclusao do desvio condicional (BEQ)\n");
  ...
  case 10:
    printf(" Estado [%d] executado.\n", *est);
    printf(" Conclusao do desvio incondicional (J)\n");
    printf(" Novo PC: %d\n", d->addr);
    break;
  }
}
